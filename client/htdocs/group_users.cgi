...
sub display_edit_user {
    ...
    if ($modifyperm) {
        $username = $q->textfield(
            -name      => 'username',
            -size      => 40,
            -maxlength => 50
        );
        $firstname = $q->textfield(
            -name      => 'first_name',
            -size      => 20,
            -maxlength => 30
        );
        $lastname = $q->textfield(
            -name      => 'last_name',
            -size      => 30,
            -maxlength => 40
        );
        ...
        $password = $q->password_field(
            -name      => 'password',
            -size      => 15,
            -maxlength => 30
        );
        $password2 = $q->password_field(
            -name      => 'password2',
            -size      => 15,
            -maxlength => 30
        );
 ...
 <ul class="menu_r">
  <li class="first">];
    ...
    if ( @$list && $user_group->{'has_children'} ) {
        print
            qq[<a href="javascript:void open_move(document.list_form.obj_list);">Move Selected Users</a></li>
  <li>];
        $opts++;
    }
