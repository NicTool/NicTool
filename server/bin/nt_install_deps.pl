...
sub get_cpan_config {
    ...
    return {
        ...
        'unzip'                   => $unzip,
        'urllist'                 => [
            'https://cpan.metacpan.org/',          'http://www.perl.com/CPAN/',
            'http://mirrors.kernel.org/pub/CPAN/', 'ftp://cpan.cs.utah.edu/pub/CPAN/',
            'ftp://mirrors.kernel.org/pub/CPAN',   'ftp://osl.uoregon.edu/CPAN/',
